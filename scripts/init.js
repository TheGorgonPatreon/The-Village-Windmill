(() => {
  const adventureName = 'The Village Windmill';
  const moduleName = 'the-village-windmill';
   ...
   */
  const welcomeJournal = 'Welcome to the Windmill!';
  /**
   ...
   */
  const additionalModulePacks = ["the-village-windmill","dnd5e"];
